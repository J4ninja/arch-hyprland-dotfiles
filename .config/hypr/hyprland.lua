...
local menu = "os.getenv(\"HOME\")/.config/hypr/scripts/rofi.sh"
...
hl.bind(mainMod .. " + " .. "space", hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/rofi.sh"))
...
-- windowrule = match:class^$,match:title^$,xwayland:1,floating:1,fullscreen:0,pinned:0
